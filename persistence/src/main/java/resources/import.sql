...
insert into message(id, header, body) values (6, 'Header7', 'Czy nosoro?ce maj? uczucia?');
...
insert into message(id, header, body) values (14, 'Header15', 'By? albo nie by?..');
insert into message(id, header, body) values (15, 'Header16', 'I like coding.');
insert into message(id, header, body) values (16, 'Header17', 'Z tymi nosoro?cami dalej nie wiem.');
insert into message(id, header, body) values (17, 'Header18', 'Xyratex');
